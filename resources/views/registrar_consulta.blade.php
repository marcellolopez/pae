                            ...
                            <div class="row">
                                    ...
                                    <div class="col-6">                        
                                        <div class="form-group ">
                                            ...
                                            <input id="telefono" type="number" class=" form-control{{ $errors->has('telefono') ? ' is-invalid' : '' }}" name="telefono" value="{{ old('telefono',$paciente->telefono) }}" placeholder="Teléfono"  required>
                                        </div>   
                                    </div>
