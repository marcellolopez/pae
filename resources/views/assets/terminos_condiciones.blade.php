        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="body">
              ...
              <p>La teleconsulta no sustituye la atención presencial, o, la relación que los pacientes tengan con sus médicos tratantes.</p>
              <p>El equipo de profesionales se encuentra formado por psiquiatras y psicólogos, con quien acepta iniciar un proceso terapéutico a distancia, cuya duración dependerá de las problemáticas señaladas por el paciente y su gravedad, las sesiones de teleconsulta tendrán una duración de 30 minutos (psiquiatría) o 45 minutos (psicología), con una frecuencia a determinar por el/la psiquiatra/psicóloga, según las necesidades del paciente.</p>
              ...
              <ol>
                ...
                <li><p>Se solicita puntualidad en las citas: el número de médicos y box es limitado, y el atraso en una sesión supondría que otras personas se viesen afectadas.</p></li>
                <li><p>Se requiere una asistencia continuada a las sesiones, en función de lo que el/la profesional determine, con previo aviso y con la máxima antelación posible en caso de no poder acudir. Una duración excesiva de la intervención debida a la falta de regularidad en la misma afectaría negativamente el proceso terapéutico.</p></li>
              ...
              <span class="subTitleLow">Consulta Médica electiva y otras profesiones: </span>
              <p>La teleconsulta es entregada por un médico u otro profesional de la salud, enfocado en atención primaria y orientaciones en salud. En esta modalidad, el profesional atiende al paciente mediante una video llamada, consiguiendo a través de esta plataforma, los antecedentes clínicos del paciente que sean requeridos para dar curso a la atención. La teleconsulta tiene ciertas limitaciones, como el no poder realizar examen físico y no poder emitir algunos documentos como licencia médica. </p>
              ...
              <p>La teleconsulta no reemplaza o sustituye la atención presencial o la relación con su médico y/o equipo médico. </p>
              <p>La teleconsulta puede generar derivaciones a urgencia o consultas presenciales. </p>
              ...
              <p>En caso de que el criterio médico lo permita, al finalizar la atención, el paciente recibirá de parte del médico una receta médica simple, para que pueda adquirir los medicamentos que requiera para el tratamiento indicado por el médico. </p>
              <p>Excluye recetas retenidas y recetas cheque. </p>

              <span class="subTitleLow">• Certificados Médicos y licencias médicas: </span>
              <p>El médico podrá entregar al paciente certificados de atención médica, válido como justificativo para ser presentado en la Institución correspondiente. También podrá entregar certificados de derivaciones médicas.
                Se excluye la emisión de licencias médicas digitales a distancia.
              </p>
              <p>El médico podrá entregar Licencias Médicas impresas o digitales de manera presencial en Centro Médico…. </p>
              ...
              <ol>
                ...
                <li><p>Una vez finalizada la etapa de ingreso y pago de la atención requerida, el profesional atenderá la consulta a través de una video llamada, y en el caso correspondiente, enviará a su correo electrónico recetas médicas, ordenes de exámenes, certificados médicos, entre otros. </p></li>
                <li><p>El médico podrá enviar los documentos clínicos necesarios, en formato PDF, al correo electrónico registrado. </p></li>
                <li><p>La reserva de horas estará disponible 365 días del año, pero la oferta disponible será restringida a la capacidad de los profesionales y la agenda que tengan disponible para este servicio. </p></li>
                <li><p>En caso de que la persona que requiera atención sea un menor de 18 años o por su condición de salud requiera actuar debidamente representado, deberá estar acompañado de una persona mayor de edad a cuyo cuidado se encuentre de su representante legal durante toda la atención clínica. </p></li>
                <li><p>Para asegurar la calidad de la video llamada y una buena experiencia de atención del paciente, éste debe estar conectado a una conexión estable de internet. Se recomienda usar una conexión a una red WiFi, o también red móvil 4G. La velocidad mínima de conexión es de 400 kbps. </p></li>
              </ol>
              ...
              <p>La cobertura de teleconsulta depende de la especialidad, de acuerdo con las normativas vigentes.
                Centro Médico Cetep se reserva el derecho de modificar los precios de teleconsulta cuando estime pertinente.
              </p>
              ...
              <p>Centro Medico Cetep no solicita datos personales o bancarios por teléfono o mail, solo información relacionada con su atención médica.</p>

              <span class="subTitleUp">VI. ANTECEDENTES PERSONALES DE LOS PACIENTES </span>
              <p>Los datos personales de los usuarios recibidos y almacenados por Centro Médico Cetep con ocasión de este servicio, son confidenciales y serán usados y/o tratados en conformidad a las disposiciones legales sobre el tema, especialmente lo dispuesto por la Ley N.º 19.628 Sobre Protección de Datos de Carácter Personal, y la Ley N.º 20.584 que Regula los Derechos y Deberes que tienen las Personas en relación con Acciones Vinculadas a su Atención de Salud. </p>
              <p>Los datos personales y sensibles que el paciente proporcione para acceder a este servicio y durante el otorgamiento de las prestaciones que requiera en el contexto de la atención clínica online, son verdaderos, y es en ellos donde se fundamenta la atención que recibe por parte de los profesionales médicos de Centro Médico Cetep, obligándose el paciente o su representante a mantener actualizada dicha información. </p>
              <p>Toda información, declaración falsa u omisión por parte del paciente o su representante en cuanto a lo anterior, habilitará a Centro Médico Cetep a cancelar la cita de teleconsulta. </p>

              <span class="subTitleUp">VII. RESERVA DE DERECHOS </span>
              <p>Centro Médico Cetep se reserva el derecho de no otorgar el servicio de atención médica online por mal uso real o potencial de este servicio, ni en caso de fuerza mayor o caso fortuito, catástrofe u ocurrencia en el momento de solicitar la atención de algún acto terrorista u otro similar. </p>
              <p>Centro Médico Cetep no se responsabiliza de los errores y omisiones propias del paciente o representante legal, o por el hecho o causa fortuita, por actos u omisiones de terceros.</p>
            </div>
          </div>
        </div>
      </div>
